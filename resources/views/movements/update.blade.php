...
<form action="{{ action('MovementController@updateMovement', $movement->id) }}" method="post" enctype="multipart/form-data">
    @method('put') @csrf
    <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="custom-select" id="movement_category_id" name="movement_category_id" class="form-control">
                                    ...
                                    <option value="{{ $category->id }}" {{ old( 'type', strval($movement->movement_category_id)) == $category->id ? "selected" : "" }}>{{ $category->name.' ---- ('. $category->type.')'}} </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="date" value="{{ $movement->date }}" class="form-control{{ $errors->has('date') ? ' is-invalid' : '' }}"
                                    name="date" required> @if ($errors->has('date'))
                                <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="value" value="{{ $movement->value }}" type="text" class="form-control{{ $errors->has('value') ? ' is-invalid' : '' }}"
                                    name="value"> @if ($errors->has('value'))
                                <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" value="{{ $movement->description }}" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                    name="description" optional> @if ($errors->has('description'))
                                <span class="invalid-feedback">
